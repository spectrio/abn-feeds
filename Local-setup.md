## To set-up for MAC M chips locally. This is for the CodeIgniter which runs on the root of this repository. To run the aggregator app seperately, go to the aggregator/Local_setup.md file
